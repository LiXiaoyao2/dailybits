...
```json
{
  ...
  "items": [
    "### GitHub Trending 总览 1/4\n| 项目 | 一句话总结 |\n| --- | --- |\n| [owner/repo](https://github.com/owner/repo)<br>⭐ 1,234 / 今日 +56 | AI 总结... |"
  ],
